...
class Test {
    ...
    public static void main(String argv[]) throws Exception {
        String user = "s2011076121@ru.ac.bd";
        String pass = "UmoxMjM0NUBSaHloYW4=";
        ...
        send("MAIL FROM:<s2011076121@ru.ac.bd>\r\n");
        System.out.println("SERVER: "+ br.readLine());


        send("RCPT TO:<aburayhansiddike@gmail.com>\r\n");
        System.out.println("SERVER: "+ br.readLine());
        ...
        send("FROM: s2011076121@ru.ac.bd\r\n");
        send("TO: aburayhansiddike@gmail.com\r\n");
